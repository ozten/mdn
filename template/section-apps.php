  ...
  <section id="content-main" role="main">
    ...
    <section class="boxed">
      <div id="popular-docs">
        ...
        <p class="all"><a href="#" class="go">All applications development documentation</a></p>
      </div>
      ...
      <div id="fave-tools">
        ...
        <ul class="tools">
          ...
          <li class="all"><a href="#" class="go">All application development tools</a></li>
        </ul>
      </div>
      ...
      <div id="recent-news">
        ...
        <p class="all"><a href="#" class="go">All application development entries</a></p>
      </div>
    </section><!-- /.boxed -->
